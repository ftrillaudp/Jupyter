...
plt.plot(data['time']*1e3, data['i_rdp1'], label='Dump Resistor')
plt.plot(data['time']*1e3, data['i_is1'], label='Source')
plt.xlabel("Time(ms)")
plt.ylabel("Current(A)")
plt.legend()
plt.savefig('./Python/all_current.png')

plt.cla()
plt.plot(data['time']*1e3, data['v_component(1)']*1e-3, label='Coil')
plt.plot(data['time']*1e3, data['v_rdp1']*1e-3, label='Dump Resistor')
plt.plot(data['time']*1e3, data['v_is1']*1e-3, label='Source')
plt.xlabel("Time(ms)")
plt.ylabel("Voltage(kV)")
plt.legend()
plt.savefig('./Python/all_voltage.png')
